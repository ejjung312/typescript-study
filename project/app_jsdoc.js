// @ts-check
// JavaScript 파일에서 타입스크립트 language 서버가 작동. 파일의 최상단에 있어야 합니다.
// 자바스크립트 소스의 양이 방대할 경우 JSDoc을 사용하여 점진적으로 타입스크립트로 변환이 가능하다.
...
// api
/**
 * @typedef {object} CovidSummery
 * @property {Array<object>} Country
 */
/**
 * 
 * @returns {Promise<CovidSummery>}
 */
